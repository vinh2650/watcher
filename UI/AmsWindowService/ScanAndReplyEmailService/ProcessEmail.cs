...
namespace ScanAndReplyEmailService
{
    public class ProcessEmail : IProcessEmail
    {
        ...
        private readonly INotificationService _postService;
        private readonly IUserService _userService;
        private readonly IEmailService _emailService;

        public ProcessEmail(INotificationService postService, IUserService userService, IEmailService emailService)
        {
